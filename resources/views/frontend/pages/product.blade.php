        ...
        <div class="col-md-6">
          ...
          <div class="mb-1 d-flex">
            <label for="option-md" class="d-flex mr-3 mb-3">
              <span class="d-inline-block mr-2" style="top:-2px; position: relative;"><input type="radio" id="option-md" name="size" value="XS"></span> <span class="d-inline-block text-black">XS</span>
            </label>
            ...
            <label for="option-xl" class="d-flex mr-3 mb-3">
              <span class="d-inline-block mr-2" style="top:-2px; position: relative;"><input type="radio" id="option-xl" name="size" value="XXL"></span> <span class="d-inline-block text-black">XXL</span>
            </label>
          </div>
          <div class="mb-5">
          ...
          <p><button type="submit" class="buy-now btn btn-sm btn-primary">Sepete Ekle</a></p>
        </form>
        </div>
      </div>
    </div>

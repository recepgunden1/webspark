...
<div class="bg-light py-3">
    <div class="container">
      <div class="row">
        <div class="col-md-12 mb-0"><a href="{{route('anasayfa')}}">anasayfa</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">iletisim</strong></div>
      </div>
    </div>
  </div>
  ...
  <div class="site-section">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="h3 mb-3 text-black">iletisim</h2>
        </div>
        <div class="col-md-7">
